...
public class Guitar_Subway extends JFrame implements KeyListener
{
    ...
    public Guitar_Subway() throws InterruptedException, BasicPlayerException
    {
        ...
        while(true)
        {
            if(prt.Inp32((short)0x379)==(short)1)
            {
                brv=true;
                for(i=0;i<notas;i++)
                {
            ...
            if(prt.Inp32((short)0x379)==(short)2)
            {
                brr=true;
                for(i=0;i<notas;i++)
                {
